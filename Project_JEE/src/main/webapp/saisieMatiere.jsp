		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="personne.dor">Utilisateurs</a></li>
						<li class="nav-item mx-0 mx-lg-1"><a
...
<div class="card">
  ...
  <div class="card-body">
      <form action="savematiere.do" method="post">
      <div class="form-group">
       ...
       <input type="text" name="id_ens" class="form-control"/>
      </div>
       <div class="form-group">
