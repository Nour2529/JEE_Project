...
<div class="card">
  ...
  <div class="card-body">
      <form action="savepersonne.do" method="post">
      <div class="form-group">
       <label class="control-label">Nom Personne :</label>
       <input type="text" name="nom" class="form-control"/>
      </div>
        <div class="form-group">
       <label class="control-label">Prenom Personne :</label>
       <input type="text" name="prenom" class="form-control"/>
      </div>
        <div class="form-group">
       <label class="control-label">Login Personne :</label>
       <input type="text" name="login" class="form-control"/>
      </div>
        <div class="form-group">
       <label class="control-label">Mot de passe Personne :</label>
       <input type="password" name="mdp" class="form-control"/>
      </div>
        <div class="form-group">
       <label class="control-label">Type Personne :</label>
